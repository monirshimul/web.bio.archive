    ...
    <div className="bg-white rounded-3xl container mx-auto p-5 shadow-md my-10">
      ...
      >
        ...
        <motion.div
          ...
          className="flex flex-col bg-slate-50/30 border border-dashed rounded-2xl p-5 shadow-sm"
        >
      ...
      <motion.div
        ...
        whileInView="show"
        viewport={{ once: false, amount: 0.25 }}
        className="flex flex-col-reverse gap-5 lg:flex-row justify-around items-center bg-slate-50/30 rounded-2xl my-3 p-5"
      >
        <motion.div
        ...
        >
          ...
          <div className="relative flex justify-between p-3">
            <ul className="bg-gray-50 p-5 rounded-md my-1 text-neutral-500 font-catamaran text-md font-semibold">
