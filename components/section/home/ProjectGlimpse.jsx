...
const ProjectGlimpse = () => {
  return (
    <div className="bg-white rounded-3xl dark:bg-slate-700/40 container mx-auto p-5 shadow-md my-10">
      <motion.div
      ...
      >
        <motion.h1
          ...
          className="my-5 text-wrap font-extralight antialiased font-catamaran capitalize text-center py-10 px-5 text-2xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-8xl 2xl:text-9xl  bg-slate-50 dark:bg-slate-800 rounded-2xl dark:shadow-md dark:shadow-cyan-500 text-neutral-600 dark:text-slate-300"
        >
