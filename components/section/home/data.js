...
export const expData = [
  {
    ...
    iconForPositionLabel: <FaUserGear className="text-green-500" size={25} />,
    companyName: "Foxcatcher IT Solution",
    iconForCompanyName: (
      <BsFillHouseGearFill className="text-green-500" size={25} />
    ),
    duration: "2022-Present",
    iconForDuration: <SlCalender className="text-green-500" size={25} />,
    address: "House: 140, Road: 4, Avenue:4, Mirpur-DOHS, Dhaka-1216",
    iconForAddress: <FaLocationDot className="text-green-500" size={25} />,
    achievement: [
  ...
  },
  {
    ...
    iconForPositionLabel: <FaUserGear className="text-cyan-500" size={25} />,
    companyName: "Era InfoTech Ltd.",
    iconForCompanyName: (
      <BsFillHouseGearFill className="text-cyan-500" size={25} />
    ),
    duration: "2019-2022",
    iconForDuration: <SlCalender className="text-cyan-500" size={25} />,
    address: "Fareast Tower, 35 Topkhana Road, (Level-3), Dhaka-1000",
    iconForAddress: <FaLocationDot className="text-cyan-500" size={25} />,
    achievement: [
